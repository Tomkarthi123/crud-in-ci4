<div class="card card-primary rounded-0">
    <div class="card-header">
        <h4 class="lg navbar-light" style="background: linear-gradient(to right, #b2fefa, #0ed2f7);"> Add New Contact Details</h4>
    </div>
    <div class="card-body">
        <div class="contianer-fluid">
            <form action="<?= base_url('main/save') ?>" method="POST" id="create-form" enctype="multipart/form-data">
                <input type="hidden" name="id">
 
                <div class="mb-3">
                    <label for="" class="control-label">Fullname (first name, last name)</label>
